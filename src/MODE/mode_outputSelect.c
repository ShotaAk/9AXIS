...
static void outputModeSelectInfo(void)
{
    ...
    myPrintfUSB("  1            USB   ASCII  9AXIS mode :Green LED ON  \n");
    myPrintfUSB("  2 UART 57600 USB   BINARY 9AXIS mode :flashing Green LED 1Hz \n");
...
void mode_outputSelect(void)
{
	...
	if(md_select != 0) setOutputMode(md_select-1);
